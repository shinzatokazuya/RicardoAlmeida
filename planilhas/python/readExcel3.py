...
try:
    ...
    df_ricardo = pd.read_csv('planilhas/csv/RICARDOALMEIDA_1858_MANT ES_1858.csv', delimiter=';')
    ...
    df_final.to_csv('planilhas/Analise_Final_Servicos_1858.csv', index=False, sep=';')

    print("Processo concluído com sucesso!")
    print("O resultado foi salvo no arquivo 'Analise_Final_Servicos_1858.csv'.")
