...
try:
    ...
    df_ricardo = pd.read_csv('planilhas/csv/RICARDOALMEIDA_1858_MANT ES_1856.csv', delimiter=';')
    ...
    df_final.to_csv('planilhas/Analise_Final_Servicos_1856.csv', index=False, sep=';')
